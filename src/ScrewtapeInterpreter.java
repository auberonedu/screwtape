...
public class ScrewtapeInterpreter {
  ...
  public Map<Integer, Integer> bracketMap(String program) {
    ...
    Stack<String> bracketPairTracker = new Stack<>();
    Stack<Integer> openBracketIndexTracker = new Stack<>();
    ...
    for (int i = 0; i < program.length(); i++) {
      ...
      if (program.charAt(i) == '[') {
        ...
        if (bracketPairTracker.peek().equals("[")) {

          bracketMap.put(closeBracketIndex, openBracketIndexTracker.peek());
